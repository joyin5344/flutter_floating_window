...
class FlutterFloatingPageRoute<T> extends PageRoute<T> {
  ...
  Widget buildTransitions(BuildContext context, Animation<double> animation,
    ...
    return buildPageTransitions<T>(
        this, context, animation, secondaryAnimation, child, settings);
  }
...
class _CupertinoBackGestureDetectorState<T>
  ...
  void _handleDragStart(DragStartDetails details) {
    ...
    FlutterFloatingManager().startDrag(context);
  }
  ...
  void _handleDragUpdate(DragUpdateDetails details) {
    ...
    FlutterFloatingManager().updateDrag(details);
  }
  ...
  void _onDragEnd() {
    FlutterFloatingManager().endDrag(context, widget.settings);
  }
